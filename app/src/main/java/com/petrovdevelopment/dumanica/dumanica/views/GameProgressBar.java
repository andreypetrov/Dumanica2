package com.petrovdevelopment.dumanica.dumanica.views;
...
import com.petrovdevelopment.dumanica.dumanica.util.ViewAttrsUtil;
...
public class GameProgressBar extends LinearLayout {
	...
	private void animateStepWidth(final View stepView) {
		...
		anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animator) {
				...
				LayoutParams layoutParams = (LayoutParams) stepView.getLayoutParams();
	...
	private View createStepView(int width) {
		...
		LayoutParams layoutParams = new LayoutParams(width, stepHeight);
